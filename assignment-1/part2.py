    ...
    for i in range(N):
        ...
        for j in range(N):
            ...
            sub_part_b *= (
                ...
                weight_linear_equations[j][0] * weight_linear_equations[i][0]
            )
            B += sub_part_b
            sub_part_c = 1
...
def run(
    ...
    calculate_efficient_frontier(stocks, read_history_records)